...
<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
            ...
            <div class="m-menu__submenu ">
                ...
                <ul class="m-menu__subnav">
                    ...
                    <li class="m-menu__item  m-menu__item--active " aria-haspopup="true">
                        ...
                        <span></span></i><span class="m-menu__link-text">{{ ucwords(__('admin.question')) }}</span></a>
                    </li>

                    <li class="m-menu__item  m-menu__item--active " aria-haspopup="true">
                        <a href="{{route('admin.quiz.results.indexView',app()->getLocale())}}" class="m-menu__link ">
                            <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                        <span></span></i><span class="m-menu__link-text">{{ ucwords(__('admin.results_quiz')) }}</span></a>
                    </li>
                </ul>
            </div>
        </li>

        <li class="m-menu__item m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-cart"></i><span
                ...
                <ul class="m-menu__subnav">
                    ...
                    <li class="m-menu__item " aria-haspopup="true">
                        <a href="{{route('admin.orders.indexView',app()->getLocale())}}" class="m-menu__link ">
                            <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                <span></span></i><span class="m-menu__link-text">{{ ucwords(__('admin.view_orders')) }}</span></a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="m-menu__item m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-email"></i><span
                ...
                <ul class="m-menu__subnav">
                    ...
                    <li class="m-menu__item " aria-haspopup="true">
                        <a href="{{route('admin.contact.indexView',app()->getLocale())}}" class="m-menu__link ">
                            <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                        <span></span></i><span class="m-menu__link-text">{{ ucwords(__('admin.contact')) }}</span></a>
                    </li>
    ...
    <li class="m-menu__item  m-menu__item--submenu m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="javascript:;" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-questions-circular-button"></i><span
    ...
    <div class="m-menu__submenu ">
        ...
        <li class="m-menu__item m-menu__item--expanded" aria-haspopup="true" m-menu-submenu-toggle="hover"><a href="{{ route('admin.setting.edit',app()->getLocale()) }}" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-settings"></i><span
