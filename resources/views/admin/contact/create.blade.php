        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <form class="form" method="post" action="{{route('admin.contact.storeView',app()->getLocale())}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control form-control-solid" name="email_contacts"
                                               value="{{ old('email_contacts')}}" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <textarea class="form-control form-control-solid" required name="message">{{old('message')}}</textarea>
                                    </div>
                                </div>
                            </div>
