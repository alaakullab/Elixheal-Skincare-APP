...
@section('title') {{ucwords(__('admin.edit_contact'))}}@endsection
@section('content')
    <div class="col-md-12">
            ...
            <form method="post" action="{{url(app()->getLocale().'/admin/contact/'. $item->id.'/update')}}"
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group">
                        ...
                        <textarea class="form-control form-control-solid" id="message" placeholder="{{ __('admin.message') }}" required name="message">{{old('message',@$item->message)}}</textarea>
                    </div>
                </div>
