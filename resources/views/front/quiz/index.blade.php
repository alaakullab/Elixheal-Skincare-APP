...
<body>
                                ...
                                <div id="wizard_container">
                                    ...
                                    <form name="example-1" id="wrapped" method="POST">
                                        ...
                                        <div id="middle-wizard">
                                            <div class="step">
                                                <h3 class="main_question"><strong>1/4</strong>What are your main skin concerns?</h3>
                                                ...
                                                <div class="form-group radio_questions">
                                                    <label>Loss of firmness or elasticity
                                                        <input name="question_1" type="radio" value="My budget is over $1500" class="icheck required">
                                                    </label>
                                                </div>
                                                <div class="form-group radio_questions">
                                ...
                                <div class="more_padding_left">
                                    <div class="widget" id="review">
                                        ...
                                        <div class="owl-carousel owl-theme add_bottom_30">
                                            <div class="item">
                                                ...
                                                <div class="testimonial-author">
                                                    <div class="img-thumbnail img-thumbnail-small">
                                                        <img src="{{url('front')}}/quiz/assets/img/avatar1.jpg" alt="">
                                                    </div>
                                                    <p>
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="testimonial-author">
                                                    <div class="img-thumbnail img-thumbnail-small">
                                                        <img src="{{url('front')}}/quiz/assets/img/avatar2.jpg" alt="">
                                                    </div>
                                                    <p>
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="testimonial-author">
                                                    <div class="img-thumbnail img-thumbnail-small">
                                                        <img src="{{url('front')}}/quiz/assets/img/avatar3.jpg" alt="">
                                                    </div>
                                                    <p>
                                    ...
                                    <div class="widget" id="gallery">
                                        ...
                                        <ul class="magnific-gallery">
                                            <li>
                                                <a href="{{url('front')}}/quiz/assets/img/gallery/large_1.jpg" title="image title">
                                                    <figure><img src="{{url('front')}}/quiz/assets/img/gallery/thumb_1.jpg" alt="thumb"></figure>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{url('front')}}/quiz/assets/img/gallery/large_2.jpg" title="image title">
                                                    <figure><img src="{{url('front')}}/quiz/assets/img/gallery/thumb_2.jpg" alt="thumb"></figure>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{url('front')}}/quiz/assets/img/gallery/large_3.jpg" title="image title">
                                                    <figure><img src="{{url('front')}}/quiz/assets/img/gallery/thumb_3.jpg" alt="thumb"></figure>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{url('front')}}/quiz/assets/img/gallery/large_4.jpg" title="image title">
                                                    <figure><img src="{{url('front')}}/quiz/assets/img/gallery/thumb_2.jpg" alt="thumb"></figure>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{url('front')}}/quiz/assets/img/gallery/large_5.jpg" title="image title">
                                                    <figure><img src="{{url('front')}}/quiz/assets/img/gallery/thumb_3.jpg" alt="thumb"></figure>
                                                </a>
                                            </li>
                                        </ul>
    ...
    <script src="{{url('front')}}/quiz/assets/js/mapmarker.jquery.js"></script>
    <script src="{{url('front')}}/quiz/assets/js/mapmarker_func.jquery.js"></script>
