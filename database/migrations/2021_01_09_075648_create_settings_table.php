...
class CreateSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('settings', function (Blueprint $table) {
            $table->id();
            $table->integer('language_id')->unsigned()->comment('Language Number To Choose a display language from table const_languages');
            ...
            $table->string('copyright')->nullable()->comment('add Copyright license website footer');
            ...
            $table->string('phone')->nullable()->comment('phone number the company for contacts');
